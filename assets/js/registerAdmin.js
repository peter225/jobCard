...
var registerAdmins = function( form, callback )
{
      ...
      xhttp.open("POST", "/superAdmins/registerAdmins", true);
...
var registerAdminButton = document.getElementById('register_admin');

registerAdminButton.addEventListener( 'click', function(){

  var adminDataForm = document.getElementById('admin-data-form');

  toastr.options = toastrOptions;
          
  toastr['info']('Connecting...please wait', 'Connecting');
        //submitButton.setAttribute('disabled', true);
  registerAdmins( adminDataForm, handleAjaxResponse );
